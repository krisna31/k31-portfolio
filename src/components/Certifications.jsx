  ...
  return (
    <Section title="Certifications">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        {data.map((cert) => (
          <div key={cert.id} className="flex items-start gap-3 p-3 sm:p-4 rounded-lg bg-slate-800/20 border border-slate-800 hover:border-emerald-500/30 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg hover:bg-slate-800/40">
